...
void RWStructuredBuffer::InitRWStructuredBuffer(int sizeOfElement, int numElement, void* initData)
{
...
void RWStructuredBuffer::InitRWStructuredBuffer(const VertexBuffer& vb, bool isUpdateByCPU)
{
